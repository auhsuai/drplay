...
// fetch time — a mid-run rotation replaces it before the retry refetches, so
// every fetch always sends the freshest token. Kept private: only
// fetchDriveWithAuthRetry consumes it.
