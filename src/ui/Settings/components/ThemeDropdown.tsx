...
export function ThemeDropdown({ currentTheme, onChange }: { currentTheme: ThemeType, onChange: (theme: ThemeType) => void }) {
  ...
  const currentOption = themes.find(tm => tm.code === currentTheme) || themes[2];
