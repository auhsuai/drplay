...
// (showFullRecent/showFullRecentlyAdded) and its hardware-back handler remain
// in HomeTab.tsx because they are view-layer state.
export function useHomeData(token: string | null, isActive: boolean) {
