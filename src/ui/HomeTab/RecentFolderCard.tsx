...
// Desktop has no mobile snap wrapper — the DOM is byte-identical to the
// inline JSX it replaced.
  ...
  return (
    ...
    >
      ...
      <div className="overflow-hidden flex-1 flex flex-col justify-center">
        <h3 className="font-semibold text-[15px] transition-colors truncate leading-tight mb-0.5 text-gray-800 dark:text-gray-200 group-hover:text-brand-text">
          {folder.name}
        </h3>
