...
export function NewFolderModal({
  ...
  // Focus-on-open is owned by ModalShell via initialFocusRef (replaces the
  // old local effect and the autoFocus prop, which jsx-a11y/no-autofocus
  // rejects).
