...
// Merged from logger.test.ts (logger.ts merged into errorLog.ts) — coverage
// of sanitizeString/sanitizeArg preserved 1:1, no case dropped.
...
describe("sanitizeString — upgrade redaction patterns", () => {
...
describe("sanitizeString — Drive id-key redaction", () => {
...
describe("sanitizeArg — upgrade circular handling", () => {
...
describe("sanitizeString — widened token/id value charset", () => {
