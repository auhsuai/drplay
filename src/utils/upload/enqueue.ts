...
// Enqueue helpers: turning seeds into queue entries and building/publishing
// their pending db.files rows so the UI can render dimmed cards before Drive
// confirms. The orchestration (startUploads) lives in pump.ts, which imports
// from here — keeping this module leaf-only avoids an import cycle.
