...
// written by usePlayerSession) and the kv store (drplay_playmode by usePlayer,
// drplay_queue by usePlayerQueue). Logout MUST clear all of them or a previous
// user's session (track/queue/playmode) resurrects in the next account.
