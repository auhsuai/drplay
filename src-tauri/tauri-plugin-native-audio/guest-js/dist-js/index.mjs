...
export const getProgressCheckpoint = async () =>
  await call("get_progress_checkpoint");
export const clearProgressCheckpoint = async () =>
  await call("clear_progress_checkpoint");
export const dispose = async () => await call("dispose");
export const addStateListener = async (handler) =>
  await addPluginListener(PLUGIN_NAME, STATE_EVENT, handler);
